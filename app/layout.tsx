...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    locale: "es_CL",
    images: [{ url: "/og-v3.png", width: 1731, height: 909, alt: "Billetera vehicular digital en un teléfono" }],
  },
  twitter: { card: "summary_large_image", title: "Billetera vehicular", description: "Tus documentos, vencimientos y mantenciones en un solo lugar.", images: ["/og-v3.png"] },
};
