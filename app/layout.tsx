...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    locale: "es_CL",
    images: [{ url: "/billetera-vehicular-hero-v2.png", width: 1731, height: 909, alt: "Billetera Vehicular con automóvil, teléfono, QR y tarjeta NFC" }],
  },
  twitter: { card: "summary_large_image", title: "Billetera vehicular", description: "Tus documentos, vencimientos y mantenciones en un solo lugar.", images: ["/billetera-vehicular-hero-v2.png"] },
};
